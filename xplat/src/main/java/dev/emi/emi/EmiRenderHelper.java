...
public class EmiRenderHelper {
	...
	public static final Identifier WIDGETS = Identifier.of("emi", "textures/gui/widgets.png");
	public static final Identifier BUTTONS = Identifier.of("emi", "textures/gui/buttons.png");
	public static final Identifier BACKGROUND = Identifier.of("emi", "textures/gui/background.png");
	public static final Identifier GRID = Identifier.of("emi", "textures/gui/grid.png");
	public static final Identifier DASH = Identifier.of("emi", "textures/gui/dash.png");
	public static final Identifier CONFIG = Identifier.of("emi", "textures/gui/config.png");
	public static final Identifier PIECES = Identifier.of("emi", "textures/gui/pieces.png");
